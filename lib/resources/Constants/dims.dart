...
class ButtonSize {
  static double header(BuildContext context) => Dims.h1FontSize(context);

  static double title(BuildContext context) => Dims.h2FontSize(context);

  static double ordinary(BuildContext context) => Dims.h3FontSize(context);
}
